        ...
        <div className={styles['hero-form']}>
            <form action='#'>
                ...
                <div className={'form__main'}>
                    <div
                        className={`form__step-one ${
                            currentStep === 1 ? 'active' : null
                        }`}
                    >
                    ...
                    <div
                        className={`form__step-two ${
                            currentStep === 2 ? 'active' : null
                        }`}
                    >
                    ...
                    <div
                        className={`form__step-three ${
                            currentStep === 3 ? 'active' : null
                        }`}
                    >
